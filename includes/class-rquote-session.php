<?php
/**
 * Handles the quote cart session with Guest Support
 */
class Woo_RQuote_Session {
    ...
    public static function add_to_cart( $product_id, $quantity = 1 ) {
        // Force session initialization for guest users
    ...
    /**
     * Force WooCommerce to set the session cookie for guest users
     */
    private static function maybe_set_session_cookie() {
